...
// #define ds18b20_delay_15us()        __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop()
...
#define DS18B20_CHECK_SUCCESS       0
#define DS18B20_CHECK_NO_DEVICE     1
